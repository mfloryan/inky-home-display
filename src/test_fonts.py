...
def test_fonts():
    ...
    for i in [12, 14, 16, 18]:
        ...
        draw.text(
            (10, x), "The quick brown fox jumps over the lazy dog " + i, font=font
        )
        x += i
    ...
    font = ImageFont.truetype(
        "/usr/share/fonts/truetype/oxygen/OxygenMono-Regular.ttf", 20
    )
    draw.text((100, 180), "Oxygen Mono ºC", font=font)

    font = ImageFont.truetype(
        "/usr/share/fonts/truetype/roboto/unhinted/RobotoTTF/Roboto-Regular.ttf", 20
    )
